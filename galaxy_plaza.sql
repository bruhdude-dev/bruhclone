...
--
-- Host: localhost:3306
-- Generation Time: Sep 18, 2021 at 06:45 PM
...
CREATE TABLE `users` (
  ...
  `genre` varchar(40) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `pronounz` varchar(40) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `play_audio` int(1) NOT NULL,
