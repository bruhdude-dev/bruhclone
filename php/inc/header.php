...
<html>
    <head>
		...
		<meta name="theme-color" content="#00bf5c" />
        <meta name="apple-mobile-web-app-title" content="<?php print(SITE_NAME); ?>">
        <meta name="description" content="bruhclone is a service that lets you communicate with other users from around the world.">
        <meta property="og:locale" content="en_US">
        <meta property="og:title" content="<?=isset($title) ? htmlspecialchars($title) . ' - ' : ''?>bruhclone">
        <meta property="og:type" content="article">
        <meta property="og:url" content="http<?=($_SERVER['HTTPS'] || HTTPS_PROXY) ? 's' : ''?>://<?=$_SERVER['SERVER_NAME']?>">
        <meta property="og:description" content="bruhclone is a service that lets you communicate with other users from around the world.">
        <meta property="og:site_name" content="bruhclone">
        <meta name="twitter:card" content="summary">
        <meta name="twitter:domain" content="<?=$_SERVER['SERVER_NAME']?>">
        <link rel="shortcut icon" href="https://res.cloudinary.com/bruhdude/image/upload/v1623717280/gmou1njeedjw82cqzfqd.png">
        <link rel="apple-touch-icon" sizes="57x57" href="https://res.cloudinary.com/bruhdude/image/upload/v1623717280/gmou1njeedjw82cqzfqd.png">
        <link rel="apple-touch-icon" sizes="114x114" href="https://res.cloudinary.com/bruhdude/image/upload/v1623717280/gmou1njeedjw82cqzfqd.png">
        <link rel="apple-touch-icon" sizes="72x72" href="https://res.cloudinary.com/bruhdude/image/upload/v1623717280/gmou1njeedjw82cqzfqd.png">
        <link rel="apple-touch-icon" sizes="144x144" href="https://res.cloudinary.com/bruhdude/image/upload/v1623717280/gmou1njeedjw82cqzfqd.png">
		<meta name="apple-mobile-web-app-capable" content="yes">
		<meta name="apple-mobile-web-app-status-bar-style" content="#00bf5c">
            ...
            <div id="sub-body">
                <menu id="global-menu">
                    <li id="global-menu-logo">
                        <h1><a href="/"><img src="/assets/img/menu-logo.png" alt="bruhclone" width="165" height="30"></a></h1>
                    </li>
                        ...
                        <ul>
                            <li id="global-menu-mymenu"<?php if(!empty($selected) && $selected == 'mymenu') echo ' class="selected"'; ?>>
                                <a href="/users/<?=htmlspecialchars($_SESSION['username'])?>">
                                    <span class="icon-container<?=$row['level'] > 0 ? ' official-user' : ''?>">
                            ...
                            <li id="global-menu-my-menu">
                                ...
                                <menu id="global-my-menu" class="invisible none">
                                    ...
                                    <li><a href="/news/messages" class="symbol my-menu-msg">
                                    <span>Messages</span>
                                    <?php 
                                    ...
                                    if($mcrow['COUNT(*)'] > 0 && (!isset($selected) || $selected != 'message')) { ?>
                                        <span><?=$mcrow['COUNT(*)']?></span>
                                    <?php }
                                ?>
                                    </a>
                                    </li>
                                    <li><a class="symbol my-menu-info" href="/communities/1"><span>bruhclone Annoucements</span></a></li>
                                    <?php if ($_SESSION['level'] > 1) { ?>
                                    <?php print "<li><a class=\"symbol my-menu-info\" onclick=\"javascript:location.href='/admin/manage/".htmlspecialchars($row['username'])."';\"><span>bruhclone Administrator Menu</span></a></li>" ?>
                                    <?php } ?>
                                    <li>
