...
<div id="sidebar">
    ...
    ?>
	<div class="adx test-adx"> <span class="adx-label">Advertisement</span> <a href="<?php print(AD2_LINK); ?>"><img src="<?php print(AD2_IMG); ?>" style="/* height: 180px; */width: 300px;"></a> </div>
                ...
                <form id="post-form" method="post" action="/posts" class="for-identified-user folded" data-post-subtype="default">
                    ...
                    <div class="post-form-footer-options">
                        <div class="post-form-footer-option-inner post-form-spoiler js-post-form-spoiler">
                            <label class="spoiler-button symbol"><input type="checkbox" name="sensitive_content" value="1"> Spoilers</label>
                        </div>
                    </div>
                    <div class="form-buttons">
