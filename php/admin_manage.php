...
?>
	...
	<div class="main-column">
		<div class="post-list-outline">
			<h2 class="label">Administrator Menu</h2>
			<section id="post-content" class="post post-subtype-default">
			    <p>Welcome to the Administrator Menu. Here, admins can do actions such as delete, purge, or ban to a default user and or themself. They can also do other things like creating communities or viewing server information.</p>
				<ul>
