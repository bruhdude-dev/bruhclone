...
if (ALLOW_SIGNUP == false) // TO-DO: add disabled reason
{
	...
	print '<div class="post-list-outline no-content center">
		<form>
			<p style="position:relative;top:105px;">
				Signups are disabled. Please contact an administrator if you think this is an error.
			</p>
		</form>
	</div>';
...
<div class="post-list-outline no-content center">
    <form method="post">
        ...
        <p>Sign up for a bruhclone account to make posts and interact with other users.</p>
