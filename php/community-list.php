...
if(empty($_SESSION['username'])) { ?>
    <div id="about">
        <div id="about-inner">
            <div id="about-text">
                <h2 class="welcome-message">Welcome to <?php print(SITE_NAME); ?>!</h2>
                <p><?php print(SITE_NAME); ?> is a place where you can communicate and chat with gamers and people who just wanna have some small talk. We have a great discovery panel, better admin tools, community creation and more! Join bruhclone today.</p>
                <div class="guest-terms-content">
                    <a class="guest-terms-link symbol" href="/info/rules">Site Rules</a>
                </div>
            </div>
