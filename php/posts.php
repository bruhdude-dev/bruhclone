    ...
    <div class="post-list-outline">
            ...
            <div class="user-content">
                ...
                <div class="user-name-content">
                    ...
                    <p class="timestamp-container">
                        ...
                        <span class="spoiler-status<?=$row['sensitive_content'] ? ' spoiler' : ''?>"> &#775; Spoilers</span>
                    </p>
                </div>
            </div>
            <div class="body">
        ...
        if($row['status'] === 0) { ?>
            ...
            if($type !== 1) { ?>
                ...
                <?php if(empty($_SESSION['username'])) { ?>
                    <div class="guest-message">
                        <p>You must sign in to post a comment.<br><br>Sign in with a bruhclone account to connect to users around the world by writing posts and comments and by giving Yeahs to other people's posts. You can sign up for a bruhclone account <a href="/signup">here</a>.</p>
                        <a href="/login" class="arrow-button"><span>Log In</span></a>
                        <a href="/signup" class="arrow-button"><span>Sign Up</span></a>
                        <a href="/info/rules" class="arrow-button"><span>bruhclone Rules</span></a>
                    </div>
                    ...
                    <div class="window">
                        ...
                        <form method="post" class="edit-post-form">
                            ...
                            <select name="edit-type">
                                ...
                                if($sensitive_content === 0) { ?><option value="spoiler" data-action="/<?=htmlspecialchars($_GET['type'] . '/' . $_GET['id'])?>.set_sensitive">Set as Spoiler</option><?php } ?>
            ...
            <div id="report-violation-page" class="dialog none" data-modal-types="report report-violation" data-is-template="1">
                <div class="dialog-inner">
                    <div class="window">
                        <h1 class="window-title">Report Violation to bruhclone Administrators</h1>
                        <div class="window-body">
                            <p class="description">You are about to report a <?=$object?> with content which violates the bruhclone Rules. This report will be sent to the bruhclone administrators and not to the creator of the post.</p>
                            <form method="post" action="/<?=htmlspecialchars($_GET['type'] . '/' . $_GET['id'])?>/violations">
                                ...
                                <select name="type" class="can-report-spoiler<?=(isset($row['community']) && $row['community'] === null) || (isset($oprow['community']) && $oprow['community'] === null) ? ' none' : ''?>">
                                    ...
                                    <option value="1" data-body-required="1"<?=(isset($row['community']) && $row['community'] === null) || (isset($oprow['community']) && $oprow['community'] === null) ? ' selected' : ''?>>bruhclone Staff</option>
                                </select>
